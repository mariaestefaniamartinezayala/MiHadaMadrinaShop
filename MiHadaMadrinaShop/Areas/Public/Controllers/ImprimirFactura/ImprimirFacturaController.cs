...
{
    [Area("Public")]
    public class ImprimirFacturaController : Controller
    {
        private readonly MiHadaMadrinaHandMadeDBContext _dbContext;

        public ImprimirFacturaController(MiHadaMadrinaHandMadeDBContext dbContext)
        {
        ...
        {
            Factura factura = _dbContext.Facturas.Where(q => q.IdPedido.Equals(id)).FirstOrDefault();
